...
function runTimer() {
    let clearInt = setInterval(() => {
        if (timer >= 0) {
            ...
            document.querySelector("#main").innerHTML = `<div class="game-over"><h1>GAME OVER</h1> <div class="your-score">Your total score is ${score}</div></div><div id="celeb-img"><img src="/mario.gif" alt=""></div> `
